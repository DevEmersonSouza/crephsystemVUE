<template>
  <div class="flex justify-content-center w-full">
    <button type="button"  @click="toggleFullScreen">Assinatura do Paciente</button>
  ...
  methods: {
    ...
    saveSignature() {
      ...
      if (this.$refs.signature) {
        ...
        localStorage.setItem('svg-paciente', svg);
        this.exitFullScreen();
        alert("Assinatura do Paciente salva com sucesso!");
      } else {
